...
<header class="site-header">
    <div class="header-inner">
        ...
        <nav class="nav-links">
            <a href="/" class="<?= basename($_SERVER['PHP_SELF']) === 'index.php' ? 'active' : '' ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> 首頁</a>
            <?php if ($currentUser): ?>
            <a href="/admin-dashboard.php" class="<?= basename($_SERVER['PHP_SELF']) === 'admin-dashboard.php' ? 'active' : '' ?>"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></svg> 管理總覽</a>
            <?php endif; ?>
        ...
        <div class="nav-user">
            ...
            <div class="user-dropdown">
                <div style="display:flex;align-items:center;gap:8px;cursor:pointer;">
                    <img src="<?= htmlspecialchars($currentUser['avatar'] ?: 'data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><defs><linearGradient id=%22ag%22 x1=%220%22 y1=%220%22 x2=%221%22 y2=%221%22><stop offset=%220%25%22 stop-color=%22%236366f1%22/><stop offset=%22100%25%22 stop-color=%22%23a855f7%22/></linearGradient></defs><circle cx=%2250%22 cy=%2250%22 r=%2248%22 fill=%22url(%23ag)%22/><circle cx=%2250%22 cy=%2238%22 r=%2214%22 fill=%22white%22 opacity=%220.9%22/><ellipse cx=%2250%22 cy=%2280%22 rx=%2224%22 ry=%2218%22 fill=%22white%22 opacity=%220.9%22/></svg>') ?>" class="nav-avatar" alt="">
                    <span style="font-size:0.9rem;"><?= htmlspecialchars($currentUser['store_name'] ?: $currentUser['email']) ?></span>
                </div>
                <div class="user-dropdown-menu">
                    <a href="/admin-dashboard.php"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></svg> 管理總覽</a>
